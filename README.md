...
```console
$ curl https://github.com/amirashad/ghctl/releases/download/v0.6.2/ghctl_darwin_amd64 -L -o /usr/local/bin/ghctl
...
```
Invoke-WebRequest https://github.com/amirashad/ghctl/releases/download/v0.6.2/ghctl_windows_amd64.exe -O ghctl.exe
```
